...
function Portfolio(){
    return(
          <div className="flex flex-col h-full d gap-[50px] pb-[150px] lg:pt-30" id="project">
            <div className=" h-[100%]  just flex flex-col justify-center ml-5  gap-3 " >
                ...
                <p className="font-medium lg:font-mono  lg:text-5xl lg:font-extrabold lg:text-center  lg:pt-25"> Select work of mine</p>
